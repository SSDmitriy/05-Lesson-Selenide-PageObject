...
import static utils.RndGenerator.*;
...
// -for Assertions
public class StudentRegistrationFormWithRndUtilsTest extends TestBase {

    //----------
    //Test data
    String firstName = getRndString(8),
            lastName = getRndString(10),
            email = getRndEmail(),
            gender = "Other",
            mobile = getRndLong(1111111111L, 9999999999L).toString(),
            dayOfBirth = "28",
            monthOfBirth = "August",
            yearOfBirth = "1980",
            //dayOfWeek = "Thursday",
